...
pub fn verify_proof(proof_path: &String, proof_options: ProofOptions){
...
pub fn prove(trace_bin_path: &String, memory_bin_path: &String, output_path: &String, proof_path: &String, proof_options: &ProofOptions){
